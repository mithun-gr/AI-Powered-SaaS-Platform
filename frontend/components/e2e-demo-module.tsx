    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 text-white max-w-3xl mx-auto my-8">
      ...
      {activeTab === 0 && (
        <div className="p-4 bg-black/50 border border-zinc-800 rounded-lg text-center space-y-4">
           ...
           {bioStatus === "idle" && (
             <button onClick={simulateBiometric} className="px-6 py-2 bg-primary/20 text-primary border border-primary/50 rounded-lg text-xs font-bold hover:bg-primary/30">
               Authorize via Face ID
             </button>
           )}
